...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        bookings.add(new Booking(room1, (Guest) List.of(guest1), simpleDateFormat.parse("2021-07-19"), simpleDateFormat.parse("2021-07-26"), "Recreation"));
        bookings.add(new Booking(room3, (Guest) List.of(guest1,guest2), simpleDateFormat.parse("2021-09-01"), simpleDateFormat.parse("2021-09-14"), "Recreation"));
